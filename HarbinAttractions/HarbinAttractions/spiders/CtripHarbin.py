import scrapy
from HarbinAttractions.items import HarbinAttractionsItem
import re
import json

class CtripHarbinSpider(scrapy.Spider):
    name = 'ctrip_harbin'
    allowed_domains = ['you.ctrip.com']
    start_urls = ['https://you.ctrip.com/sight/harbin151.html']

    def parse(self, response):
        # 解析首页
        for sight in response.css('div.list_mod2'):
            item = HarbinAttractionsItem()
